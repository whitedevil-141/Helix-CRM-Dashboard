...
import { Sparkline, DonutChart, GrowthChart } from '@/components/Charts';
...
function CmpSection({ id, title, desc, children }: CmpSectionProps) {
  return (
  ...
  return (
    <>
      <div className="cmp-row">
        ...
        <button className="btn" onClick={dispatchOpenPalette}>Open command palette</button>
      </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12 }}>
              <div className="card">
                ...
                <div style={{ position: 'relative', height: 40, marginTop: 10 }}>
                  <Sparkline data={[12, 14, 16, 15, 18, 19, 22, 24, 23, 27, 30, 32]} width={240} height={36} color="var(--accent)"/>
                </div>
              </div>
              <div className="card">
              ...
              <div className="card">
                ...
                <div style={{ marginTop: 6 }}>
                  <GrowthChart data={[28, 34, 32, 42, 49, 55, 58, 64]} labels={['M', 'T', 'W', 'T', 'F', 'S', 'S', 'M']}/>
                </div>
              </div>
            </div>
          </CmpSection>
